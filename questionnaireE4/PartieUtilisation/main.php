		...
		//
			...
			echo "<div id=\"tabs\">";			
				echo "<ul>";
					...
					echo "<li><a href=\"#\" rel=\"e4.php\" onClick=\"loadit(this)\">Affectation salariés dans services</a></li>";
					echo "<li><a href=\"#\" rel=\"consultation.php\" onClick=\"loadit(this)\">Affichage nombre salariés par services</a></li>";
				echo "</ul>";
