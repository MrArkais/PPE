...
class DAOSalaries{
	...
	public function selectionnerTous(){
		$resultat = $this->db->query("Select id, prenom, nom, login, mdp, idEntreprise from salarie");
	...
	public function recupererIdSalarie($login,$mdp){
		$donnees=-1;
		$requete = "Select id, prenom, nom, login, mdp, idEntreprise from salarie where login='$login' and mdp='$mdp'" ;
